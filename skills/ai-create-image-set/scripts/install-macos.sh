#!/usr/bin/env bash
# ai-create-image-set -- One-Shot-Installer fuer macOS/Linux
# Kopiert das Skill nach ~/.claude/skills/ai-create-image-set/ und startet den Preflight.
#
...
TARGET="$CLAUDE_SKILLS/ai-create-image-set"

step() { printf "\n\033[1;34m==>\033[0m %s\n" "$1"; }
ok()   { printf "    \033[32mOK\033[0m %s\n" "$1"; }
warn() { printf "    \033[33mWARN\033[0m %s\n" "$1"; }

step "ai-create-image-set One-Shot-Installer (macOS/Linux)"
